export const Data = {
  profile: {
    name: "MD HREDOY MESHA",
    ocupation: "IT ANALYST",
    location: "Turku, Finland",
    email: "meshahredoy@gmail.com",
    telephone: "+358414799746",
  ...
  experience: {
    ...
    academic: [
      {
        career: "GOVERNANCE OF DIGITALIZATION",
        date: "09.2021 – present | Turku, Finland",
        institution: "Åbo Akademi University",
      },
      {
        career: 'Bachelor of Business Administration',
        date: '10.2016 – 02.2020 | Vilnius, Lithuania',
